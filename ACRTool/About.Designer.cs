...
namespace ACRTool
{
	partial class About
	{
		...
		private void InitializeComponent()
		{
			...
			this.label3.Text = "Powered by ACRCloud API. Written by Etheriaa.\r\nCompatible with all Windows versio" +
	"ns with .NET Framework 4.0 support.\r\nWorks best on Windows 7/10/11.";
			// 
			// linkLabel1
			// 
